...
<header class=" px-[15%] border-b-[1px] border-[#2aa198] text-[#2aa198] flex items-center justify-between">
    <a href="/"><h1 class="font-bold text-[24px] text-left leading-[2.5rem]">DEFAULT DETECTOR</h1></a>
    <div class="text-[20px]">
